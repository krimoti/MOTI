...
const DazuraKnowledge = (() => {
  ...
  function getTimeContext() {
    ...
    if (h < 10) return { label: 'בוקר', emoji: '☀️', greeting: 'בוקר טוב' };
    if (h < 13) return { label: 'בוקר', emoji: '🌟', greeting: 'צהריים טובים' };
    if (h < 17) return { label: 'צהריים', emoji: '☕', greeting: 'אחר הצהריים טובים' };
